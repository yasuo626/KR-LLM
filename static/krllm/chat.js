...
var api_url=document.getElementById('api_url').innerText
var home_url=api_url+'/krllm/'

var api_user = api_url+'/wmc/apiuser';

var api_krdroid_file_upload = api_url+'/krdroid/file_upload';
var api_krdroid_file_get = api_url+'/krdroid/file_get';
var api_krdroid_file_get_detail = api_url+'/krdroid/file_get_detail';
...
var api_krdroid_kb_get = api_url+'/krdroid/kb_get';
var api_krdroid_kb_get_detail = api_url+'/krdroid/kb_get_detail';
var api_krdroid_kb_add_files = api_url+'/krdroid/kb_add_files';
var api_krdroid_kb_get_files = api_url+'/krdroid/kb_get_files';
var api_krdroid_kb_get_valid_files = api_url+'/krdroid/kb_get_valid_files';
...
// create_msg('info','this is info',main_block);
// create_msg('user','this is info',main_block);
// create_msg('assistant','this is info',main_block);
// create_msg('user','this is info',main_block);
// create_msg('assistant','this is info',main_block);
// create_msg('info','this is info',main_block);
// create_msg('user','this is info',main_block);
